...
def build_model():
    ...
    # Set grid search
    cv = GridSearchCV(estimator=pipeline, param_grid=parameters, cv=2, scoring='f1_weighted', verbose=3)
...
def main():
    if len(sys.argv) == 5:
        ...
        print('Please provide the filepath of the disaster messages database '\
              ...
              'train_classifier.py ../data/DisasterResponse.db classifier.pkl vocabulary.pkl category.pkl')
